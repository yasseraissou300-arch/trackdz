                ...
                <th className="w-10 px-4 py-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setSelected(checked ? commandes.map((c) => c.id) : [])
                    }
                  />
                </th>
                  ...
                  return (
                    <tr
                      ...
                      className={cn(
                        ...
                        selected.includes(commande.id) && 'bg-primary/5'
                      )}
                    >
                      <td className="px-4 py-3">
                        <Checkbox
                          checked={selected.includes(commande.id)}
                          onCheckedChange={() => toggleSelect(commande.id)}
                        />
                      </td>
                      <td className="px-4 py-3">
                        ...
                        {lastWa ? (
                          <span
                            className={cn(
                              ...
                              lastWa.statut === 'ECHEC' ? 'bg-red-100 text-red-700' :
                              'bg-yellow-100 text-yellow-700'
                            )}
                          >
                            {lastWa.statut === 'LU' ? 'Lu' :
                             lastWa.statut === 'DELIVRE' ? 'Délivré' :
                             lastWa.statut === 'ENVOYE' ? 'Envoyé' :
                             lastWa.statut === 'ECHEC' ? 'Échec' : 'En attente'}
                          </span>
                        ) : (
                      ...
                      <td className="px-4 py-3">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            {commande.trackingNumber && (
                              <DropdownMenuItem
                                onClick={() => copyTracking(commande.trackingNumber!)}
                              >
